...
# обработка nld +
# выбор полей для работы из nld (СДЕЛАТЬ МИКСЕД + КАПСОМ ВСЕ КОНСТАНТЫ) -+
# логирование вывода в файл +
# сохранение модели и метрик (название зависит от параметров, путь сохранения параметр) +
# расширенный выбор параметров для экспериментов +
# добавить в вывод изменение формул (оно есть в ноутбуке) +
# посмотреть записку, что там было, про миксед потом оставить ?

# Осталось: веса, миксед и ридми
